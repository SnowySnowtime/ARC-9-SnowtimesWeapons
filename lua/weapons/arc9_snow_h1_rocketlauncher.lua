...
SWEP.ViewModel = "models/snowysnowtime/arc9/hce/rifles/c_fp_cerocket.mdl"
...
SWEP.Animations = {
	...
	["enter_inspect"] = {
		...
		EventTable = {
            {
                t = 0, -- in seconds
                s = "arc9.cerl.spin_start", -- sound to play
                c = CHAN_ITEM, -- sound channel
                e = "", -- effect to emit
            }
        },
	...
	["idle_inspect"] = {
		...
		EventTable = {
            {
                t = 0, -- in seconds
                s = "arc9.cerl.spin", -- sound to play
                c = CHAN_ITEM, -- sound channel
                e = "", -- effect to emit
            }
        },
	...
	["exit_inspect"] = {
		...
		EventTable = {
            {
                t = 0, -- in seconds
                s = "arc9.cerl.spin_end", -- sound to play
                c = CHAN_ITEM, -- sound channel
                e = "", -- effect to emit
            }
        },
