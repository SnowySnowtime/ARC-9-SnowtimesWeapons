...
This weapon has been adjusted for Profiteers.]]
	...
	SWEP.PhysBulletModel = nil
	SWEP.PhysBulletModelStick = nil
	SWEP.PhysBulletMuzzleVelocity = 6000
	SWEP.BodyDamageMults = {
		[HITGROUP_HEAD] = 2,
		[HITGROUP_CHEST] = 1,
		[HITGROUP_STOMACH] = 1,
...
SWEP.TracerNum = 1
SWEP.PhysBulletModel = "models/snowysnowtime/arc9/projectiles/pr_projectile.mdl"
SWEP.ImpactEffect = "effect_arc9_halo_ce_impact_pr"
SWEP.SuppressSmokeTrail = false

SWEP.RicochetChance = 0
--SWEP.MuzzleEffect = "muzzleflash_4"
SWEP.MuzzleParticle = "arc9ce_halo_2_muzzle_plasma_rifle" -- Used for some muzzle effects.
